...
export const metadata: Metadata = {
  ...
  title: {
    default: `${SITE_NAME} - Free Online Tools for Images, PDFs & More`,
  ...
  creator: SITE_NAME,
  openGraph: {
    title: `${SITE_NAME} - Free Online Tools for Images, PDFs & More`,
    description: SITE_DESCRIPTION,
    url: SITE_URL,
    siteName: SITE_NAME,
    locale: "en_US",
...
gtag('config', 'G-9TN9YGWPW2');`,
      ...
      <body className="flex min-h-screen flex-col">
        ...
        <AdSlot slot="header" className="mx-auto mt-4 max-w-5xl px-4" />
